        ...
        {showCloseButton && (
          <DialogPrimitive.Close
            ...
            render={
              <Button
                variant="ghost"
                className="absolute top-2.5 right-2.5 h-7 w-7 text-muted-foreground hover:text-foreground cursor-pointer"
                size="icon-xs"
              />
            }
          >
...
function DialogFooter({
  ...
  return (
    <div
      ...
      className={cn(
        "-mx-4 -mb-4 flex flex-col-reverse gap-2 rounded-b-md border-t border-border bg-muted/40 p-4 sm:flex-row sm:justify-end",
        className
      )}
      {...props}
    />
